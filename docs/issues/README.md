...
| LOCAL-004 | [创建 Cloudflare 预览分支](./004-preview-release.md) | [GitHub #6](https://github.com/yuukiLike/bamboo-old-house/issues/6)，待应用固定分支规则 | 1 | 仅 `preview` 触发非生产预览，普通分支不构建；正式版本 `03f1fb5a` 不变 |
