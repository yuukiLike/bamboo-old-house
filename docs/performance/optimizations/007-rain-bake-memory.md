...
本文是[第六阶段优化](006-mobile-gpu-residency.md)的雨效内存专题附录，不代表已发布的独立第七阶段。父版本为 `e23daec77945c4b70d07f0956a9bcdc12232fe45`。2026-09-26 先归档文档与证据，本文对应实现仍在本地工作区，尚未作为生产修复提交或推送；后续状态见[调查检查点](../iphone-investigation-status.md)。
